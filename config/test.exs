...
config :kanban, KanbanWeb.Endpoint,
  ...
  secret_key_base: "ZDX0gv4BnnGlPFkcXzpReigxcba4n40OLtC9Y8CHpVy8X3jXuigEgxpu0Bv5sFuu",
  server: false
...
config :kanban, KanbanWeb.Endpoint,
  http: [ip: {127, 0, 0, 1}, port: 4002],
  secret_key_base: "YaVO/a7BcTByZzqRV7TQZb8IJBa1W7kpVS59mO+GZfkMseO7AYwXRw9rdV+fAGBQ",
  server: false
